...
namespace SpaceShooter
{
    public class Game1 : Game
    {
        ...
        private TextManagement   textManagement   = new TextManagement();
        private ObjectManagement objectManagement;

        private SpriteFont font;
        private int        playerCount = 1;
        private double     whenDeployedTutorial;
        ...
        public Game1()
        {
            ...
            objectManagement = new ObjectManagement(_graphics.PreferredBackBufferHeight, _graphics.PreferredBackBufferWidth);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            foreach (SpaceShip item in objectManagement.spaceShips)
            {
                _spriteBatch.Draw(
                item.texture,
                item.position,
            ...
            foreach (Lazer item in objectManagement.lazers)
            {
                _spriteBatch.Draw(
                item.texture,
                item.position,
            ...
            /*
            foreach (Asteroid item in objectManagement.asteroids)
            {
                _spriteBatch.Draw(
                item.texture,
                item.position,
